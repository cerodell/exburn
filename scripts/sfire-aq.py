...
for i in range(len(aq_ids)):
    ...
    ax.plot(aq_dfs[i].index.values, aq_dfs[i].pm25.values, color = colors[i], linestyle = '--')
ax.scatter(pd.Timestamp(2019, 5, 11, 17, 49, 3), 0, marker= "*", color = 'red', zorder = 10, label = 'Ignition Time', s = 100)
