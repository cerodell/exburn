...
try:
    ...
    ## save tree
    pickle.dump([dmtree, dmlocs], open(str(root_dir) + f"/data/tree/dmtree.p", "wb"))
...
# plt.title('CLOSEUP OF THE FIRE PLOT')
# bmX = Basemap(llcrnrlon=XLONG[300,350], llcrnrlat=XLAT[300,350],\
# 					 urcrnrlon=XLONG[600,500], urcrnrlat=XLAT[500,500],  epsg=4326)
# polygonsX = bmX.readshapefile(fireshape_path,name='units',drawbounds=True, color='red')
# bmX.contourf(XLONG[300:600,350:500], XLAT[300:600,350:500],fuel[300:600,350:500])
# plt.colorbar(orientation='horizontal',label='fuel category')
# plt.scatter(XLONG[402,404], XLAT[402,404],c='red', label='ignition start')
# plt.scatter(XLONG[402,401], XLAT[458,400],c='red',marker='*',label='ignition end')
# plt.legend()
# plt.show()
...
# plt.figure(figsize=(20,12))
# plt.title('CLOSEUP OF THE FIRE PLOT')
# bmX = Basemap(llcrnrlon=X[300,350], llcrnrlat=XLAT[300,350],\
# 					 urcrnrlon=X[600,500], urcrnrlat=XLAT[500,500],  epsg=4326)
# polygonsX = bmX.readshapefile(fireshape_path,name='units',drawbounds=True, color='red')
# bmX.contourf(X[300:600,350:500], XLAT[300:600,350:500],fuel[300:600,350:500])
# plt.colorbar(orientation='horizontal',label='fuel category')
# plt.scatter(X[402,436], XLAT[406,404],c='red',marker='*',label='ignition start')
# plt.scatter(X[402,404], XLAT[402,404],c='red', label='ignition end')
# plt.legend()
# plt.show()

# dmlocs = [-113.5765, 55.72214]
# find closest lat, lon (kd-tree) to the fire
# unit_loc = np.array(dmlocs).reshape(1, -1)
# dist, ind = unit_tree.query(unit_loc, k=1)
...
# plt.figure(figsize=(20,12))
# plt.title('CLOSEUP OF THE FIRE PLOT')
# bmX = Basemap(llcrnrlon=X[300,300], llcrnrlat=XLAT[300,300],\
# 					 urcrnrlon=X[900,580], urcrnrlat=XLAT[610,580],  epsg=4326)
# polygonsX = bmX.readshapefile(fireshape_path,name='units',drawbounds=True, color='red')
# bmX.contourf(X[300:600,350:500], XLAT[300:600,350:500],fuel[300:600,350:500])
# plt.colorbar(orientation='horizontal',label='fuel category')
# plt.scatter(X[402,436], XLAT[406,404],c='red',marker='*',label='ignition start')
...
# currently manualy get actual ignition locations (enter these in your namelist.input)
# #UNIT 4 WESTERLY
print("fire_ignition_start_x1 = %s" % gridx[402, 404])
print("fire_ignition_start_y1 = %s" % gridy[402, 404])
print("fire_ignition_end_x1 = %s" % gridx[402, 401])
print("fire_ignition_end_y1 = %s" % gridy[458, 400])


# #UNIT 4 SOUTHERLY
print("fire_ignition_start_x1 = %s" % gridx[402, 436])
print("fire_ignition_start_y1 = %s" % gridy[406, 404])
print("fire_ignition_end_x1 = %s" % gridx[402, 404])
print("fire_ignition_end_y1 = %s" % gridy[402, 404])
